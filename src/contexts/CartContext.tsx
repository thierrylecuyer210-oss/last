...
interface CartContextType {
  items: CartItem[];
  addToCart: (product: any, sizeOption: { quantity: string; multiplier: number }, amount: number) => void;
...
export const CartProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const addToCart = (product: any, sizeOption: { quantity: string; multiplier: number }, amount: number) => {
    const selectedTier = sizeOption;
