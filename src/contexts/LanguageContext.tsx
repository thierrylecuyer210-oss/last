...
const en = {
  ...
  'cart.description': 'Review your items below. You can update quantities or remove items before proceeding to checkout.',
...
const nl: typeof en = {
  ...
  'cart.description': 'Bekijk uw artikelen hieronder. U kunt hoeveelheden bijwerken of items verwijderen voordat u naar de kassa gaat.',
...
const de: typeof en = {
  ...
  'cart.description': 'Überprüfen Sie Ihre Artikel unten. Sie können Mengen aktualisieren oder Artikel entfernen, bevor Sie zur Kasse gehen.',
